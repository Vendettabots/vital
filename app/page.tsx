    ...
    <div className="container">
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Premium <span>Home Care</span> Services for Your Loved Ones</h1>
          <p>Compassionate, professional caregivers providing personalized care to help seniors live comfortably and independently at home.</p>
      ...
      <section id="assessment" className="assessment">
        ...
        <form className="assessment-form">
          <div className="form-group"><label htmlFor="name">Full Name</label><input type="text" id="name" placeholder="John Smith" /></div>
          <div className="form-group"><label htmlFor="phone">Phone Number</label><input type="tel" id="phone" placeholder="(123) 456-7890" /></div>
          <div className="form-group"><label htmlFor="email">Email Address</label><input type="email" id="email" placeholder="john@example.com" /></div>
          <div className="form-group"><label htmlFor="location">Location</label><input type="text" id="location" placeholder="City, State" /></div>
            ...
            <div className="checkbox-group">
              {["personal-care", "companionship", "medication", "mobility", "dementia", "other"].map(id => (
                <div className="checkbox-item" key={id}>
                  ...
                  <label htmlFor={id}>{id.replace("-", " ").replace(/\b\w/g, c => c.toUpperCase())}</label>
                </div>
              ))}
            </div>
          </div>
          <div className="form-group full-width">
            ...
            <textarea id="message" rows={4} placeholder="Tell us about your specific needs..."></textarea>
          </div>
          <div className="form-group full-width">
            <button type="submit" className="btn btn-primary" style={{ width: '100%' }}>Submit Assessment Request</button>
          </div>
        </form>
      </section>
